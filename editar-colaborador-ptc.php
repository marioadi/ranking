...
if(isset($_POST['nome-panel']) && !empty($_POST['nome-panel'])){
  ...
  $dados_colab = $colab->colabAuthPtc($id_colab);
}
...
<head>
  ...
  <title>C&A Ranking | Editar PTC</title>
              ...
              <div class="col-md-12">
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Dados dos Colaboradores da PTC</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
