...
if(isset($_POST['nome-panel']) && !empty($_POST['nome-panel'])){
  $id_colab = $_POST['id-panel'];
  $dados_colab = $colab->colabAuthPcj($id_colab);
}

if(isset($_POST['nome-edit']) && !empty($_POST['nome-edit'])){
  $colab->updateColabPcj($_POST['id-edit'], $_POST['nome-edit'], $_POST['valor-edit'], $_POST['data-edit']);
  $dados_colab = $colab->colabAuthPcj($_POST['id-edit']);
}
...
<head>
  ...
  <title>C&A Ranking | Editar PCJ</title>
              ...
              <div class="col-md-12">
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Dados dos Colaboradores do PCJ</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                         ...
                         <div class="container">
                              ...
                              <div class="col-xs-12 col-sm-12">
                                  <div  class="form-group espaco-topo">
                                      <div class="col-xs-12 col-sm-4">
                                          ...
                                          <input type="hidden" name="id-edit" value="<?php echo $dados_colab['id'];?>">
                                          <input class="form-control" type="text" value="<?php echo $dados_colab['nome'];?>" name="nome-edit" >
                                      </div>
                                      <div class="col-xs-12 col-sm-4">
							...
							<div class="col-sm-12">
							  <div class="painel-botoes">
									...
									<button type="submit" class="btn btn-success"><i class="fa fa-plus"></i> Atualizar</button>  
							  </div>
							</div>    
                        </div>
                  </form>
