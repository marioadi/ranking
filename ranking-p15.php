...
<head>
  ...
  <title>C&A Ranking | Ranking P15</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php $usuario->getNome(); ?></span>
            </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ranking P15</li>
      </ol>
    </section>
      ...
      <div class="row">
		...
		<div class="col-sm-12">
          <div class="painel-botoes">
              ...
              <a href="cadastro-colaboradores-p15.php" class="btn btn-success">
