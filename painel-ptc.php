...
if(isset($_POST['id_colab'])){
  $colab->removeColabPtc($_POST['id_colab']);
}
?>
...
<head>
  ...
  <title>C&A Ranking | Painel PTC</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Lista de colaborades cadastrados - PTC</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  $sql = $colab->listAllPtc();
                  if($sql->rowCount() > 0){
                    foreach ($sql->fetchAll() as $ln) {
                      $ln = $colab->colabAuthPtc($ln['id']);    
                ?>
                    <tr>
                      ...
                      <td style=" width: 100px;">
                        ...
                        <form action="editar-colaborador-ptc.php" method="POST" style="float: left;">
