...
if(isset($_POST['id_colab'])){
  $colab->removeColabP15($_POST['id_colab']);
}
?>
...
<head>
  ...
  <title>C&A Ranking | Painel P15</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Lista de colaborades cadastrados - P15</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  // $sql = $colab->listarTodos();
                $sql = $colab->listAllP15();
                  if($sql->rowCount() > 0){
                    foreach ($sql->fetchAll() as $ln) {
                      $ln = $colab->colabAuthP15($ln['id']);    
                ?>
                    <tr>
                      ...
                      <td style=" width: 100px;">
                        ...
                        <form action="editar-colaborador-p15.php" method="POST" style="float: left;">
