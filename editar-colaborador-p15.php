...
if(isset($_POST['nome-panel']) && !empty($_POST['nome-panel'])){
  ...
  $dados_colab = $colab->colabAuthP15($id_colab);
}

if(isset($_POST['nome-edit']) && !empty($_POST['nome-edit'])){
  $colab->updateColabP15($_POST['id-edit'], $_POST['nome-edit'], $_POST['valor-edit'], $_POST['data-edit']);
  $dados_colab = $colab->colabAuthP15($_POST['id-edit']);
}
...
<head>
  ...
  <title>C&A Ranking | Editar P15</title>
              ...
              <div class="col-md-12">
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Dados dos Colaboradores do P15</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
